...
\section{超強結合領域におけるZeemanポラリトンの定量的記述}
...
\subsection{Holstein-Primakoff変換によるボゾン化}
...
\subsection{Bogoliubov変換と固有エネルギー}
...
\subsection{基底状態の量子性（Vacuum Properties）}
